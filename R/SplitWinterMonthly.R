...
SplitWinterMonthly <- function(input, index, percentiles){
#remove if package
	if(!require(dplyr)){
...
#			}
			...
			for (k in 1:length(stats[[i]][[n]][["Thresholds"]][["Totals"]][["Thresholds"]])){
				stats[[i]][[n]][["Thresholds"]][["Totals"]][["DaysAbove"]][[k]] <- sum(stats[[i]][[n]][["Thresholds"]][["coded"]][[k]], na.rm=TRUE)
				stats[[i]][[n]][["Thresholds"]][["Totals"]][["FracDaysAbove"]][[k]] <- sum(stats[[i]][[n]][["Thresholds"]][["coded"]][[k]], na.rm=TRUE)/(length(stats[[i]][[n]][["Thresholds"]][["coded"]][[k]])-sum(is.na(stats[[i]][[n]][["Thresholds"]][["coded"]][[k]])))
				stats[[i]][[n]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[k]] <- sum(wint_by_year[[i]][[n]][["Discharge_acfte6_day"]][which(stats[[i]][[n]][["Thresholds"]][["coded"]][[k]]==1)], na.rm=TRUE)
...
#		}
		...
		for (p in 1:length(percentiles)){
			for (n in 1:length(all[[k]][["Data"]][["Discharge_acfte6_day"]])){
				if(is.na(all[[k]][["Data"]][["Discharge_acfte6_day"]][[n]])){
					all[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
				} else if (all[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] >= percentiles[[p]]){
					all[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 1
				} else if (all[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] < percentiles[[p]]){
					all[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 0	
				} else {
					all[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
				}
			}
		...
		for (i in 1:length(all[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]])){
			all[[k]][["Stats"]][["Thresholds"]][["Totals"]][["DaysAbove"]][[i]] <- sum(all[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)
			all[[k]][["Stats"]][["Thresholds"]][["Totals"]][["FracDaysAbove"]][[i]] <- sum(all[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)/(length(all[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])-sum(is.na(all[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])))
			all[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(all[[k]][["Data"]][["Discharge_acfte6_day"]][which(all[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)], na.rm=TRUE)
	...
	#			XC[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XC[[k]][["Data"]][["Discharge_acfte6_day"]][which(XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)])
			...
			for (p in 1:length(percentiles)){
				for (n in 1:length(XC[[k]][["Data"]][["Discharge_acfte6_day"]])){
					if(is.na(XC[[k]][["Data"]][["Discharge_acfte6_day"]][[n]])){
						XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					} else if (XC[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] >= percentiles[[p]]){
						XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 1
					} else if (XC[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] < percentiles[[p]]){
						XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 0	
					} else {
						XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					}
				}
			...
			XC[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]] <- c(0.05,0.1,0.2,0.25,0.5,0.75,0.9,0.95)
			for (i in 1:length(XC[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]])){
				XC[[k]][["Stats"]][["Thresholds"]][["Totals"]][["DaysAbove"]][[i]] <- sum(XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)
				XC[[k]][["Stats"]][["Thresholds"]][["Totals"]][["FracDaysAbove"]][[i]] <- sum(XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)/(length(XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])-sum(is.na(XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])))
				XC[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XC[[k]][["Data"]][["Discharge_acfte6_day"]][which(XC[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)], na.rm=TRUE)
	...
	#			XD[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XD[[k]][["Data"]][["Discharge_acfte6_day"]][which(XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)])
			...
			for (p in 1:length(percentiles)){
				for (n in 1:length(XD[[k]][["Data"]][["Discharge_acfte6_day"]])){
					if(is.na(XD[[k]][["Data"]][["Discharge_acfte6_day"]][[n]])){
						XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					} else if (XD[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] >= percentiles[[p]]){
						XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 1
					} else if (XD[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] < percentiles[[p]]){
						XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 0	
					} else {
						XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					}
				}
			...
			XD[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]] <- c(0.05,0.1,0.2,0.25,0.5,0.75,0.9,0.95)
			for (i in 1:length(XD[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]])){
				XD[[k]][["Stats"]][["Thresholds"]][["Totals"]][["DaysAbove"]][[i]] <- sum(XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)
				XD[[k]][["Stats"]][["Thresholds"]][["Totals"]][["FracDaysAbove"]][[i]] <- sum(XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)/(length(XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])-sum(is.na(XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])))
				XD[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XD[[k]][["Data"]][["Discharge_acfte6_day"]][which(XD[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)], na.rm=TRUE)
	...
	#			XBN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XBN[[k]][["Data"]][["Discharge_acfte6_day"]][which(XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)])
			...
			for (p in 1:length(percentiles)){
				for (n in 1:length(XBN[[k]][["Data"]][["Discharge_acfte6_day"]])){
					if(is.na(XBN[[k]][["Data"]][["Discharge_acfte6_day"]][[n]])){
						XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					} else if (XBN[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] >= percentiles[[p]]){
						XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 1
					} else if (XBN[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] < percentiles[[p]]){
						XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 0	
					} else {
						XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					}
				}
			...
			XBN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]] <- c(0.05,0.1,0.2,0.25,0.5,0.75,0.9,0.95)
			for (i in 1:length(XBN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]])){
				XBN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["DaysAbove"]][[i]] <- sum(XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)
				XBN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["FracDaysAbove"]][[i]] <- sum(XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)/(length(XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])-sum(is.na(XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])))
				XBN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XBN[[k]][["Data"]][["Discharge_acfte6_day"]][which(XBN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)], na.rm=TRUE)
	...
	#			XAN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XAN[[k]][["Data"]][["Discharge_acfte6_day"]][which(XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)])
			...
			for (p in 1:length(percentiles)){
				for (n in 1:length(XAN[[k]][["Data"]][["Discharge_acfte6_day"]])){
					if(is.na(XAN[[k]][["Data"]][["Discharge_acfte6_day"]][[n]])){
						XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					} else if (XAN[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] >= percentiles[[p]]){
						XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 1
					} else if (XAN[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] < percentiles[[p]]){
						XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 0	
					} else {
						XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					}
				}
			...
			XAN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]] <- c(0.05,0.1,0.2,0.25,0.5,0.75,0.9,0.95)
			for (i in 1:length(XAN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]])){
				XAN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["DaysAbove"]][[i]] <- sum(XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)
				XAN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["FracDaysAbove"]][[i]] <- sum(XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)/(length(XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])-sum(is.na(XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])))
				XAN[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XAN[[k]][["Data"]][["Discharge_acfte6_day"]][which(XAN[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)], na.rm=TRUE)
	...
	#			XW[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XW[[k]][["Data"]][["Discharge_acfte6_day"]][which(XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)])
			...
			for (p in 1:length(percentiles)){
				for (n in 1:length(XW[[k]][["Data"]][["Discharge_acfte6_day"]])){
					if(is.na(XW[[k]][["Data"]][["Discharge_acfte6_day"]][[n]])){
						XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					} else if (XW[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] >= percentiles[[p]]){
						XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 1
					} else if (XW[[k]][["Data"]][["Discharge_acfte6_day"]][[n]] < percentiles[[p]]){
						XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- 0	
					} else {
						XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[names(percentiles)[p]]][[n]] <- NA
					}
				}
			...
			XW[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]] <- c(0.05,0.1,0.2,0.25,0.5,0.75,0.9,0.95)
			for (i in 1:length(XW[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Thresholds"]])){
				XW[[k]][["Stats"]][["Thresholds"]][["Totals"]][["DaysAbove"]][[i]] <- sum(XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)
				XW[[k]][["Stats"]][["Thresholds"]][["Totals"]][["FracDaysAbove"]][[i]] <- sum(XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]], na.rm=TRUE)/(length(XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])-sum(is.na(XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]])))
				XW[[k]][["Stats"]][["Thresholds"]][["Totals"]][["Volume_Abv_acfte6"]][[i]] <- sum(XW[[k]][["Data"]][["Discharge_acfte6_day"]][which(XW[[k]][["Stats"]][["Thresholds"]][["coded"]][[i]]==1)], na.rm=TRUE)
