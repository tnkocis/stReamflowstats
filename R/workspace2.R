...
if(as.numeric(USGS11377100$raw$site_no[[1]]) %in% SacV_gauges$site_no){
	...
	USGS11377100$Index$Index <- YEARTYPEqdf$SacV_num
	USGS11377100$Index$Year <- YEARTYPEqdf$Year
} else if(as.numeric(USGS11377100$raw$site_no[[1]]) %in% SJV_gauges$site_no){
	USGS11377100$Index$Valley <- "SJV"
	USGS11377100$Index$Index <- YEARTYPEqdf$SJV_num
	USGS11377100$Index$Year <- YEARTYPEqdf$Year
} else {
...
write.csv(USGS11377100$thresholds_maf, file=file.path(maindir, gaugedir, thresholdsdir, paste(as.character(USGS11377100$raw$site_no[[1]]),"_","Thresholds_maf.csv",sep="")))

dir.create(file.path(maindir, gaugedir, recordstatsdir))
write.csv(paddf(USGS11377100$record_stats[1:7]), file=file.path(maindir, gaugedir, recordstatsdir, paste(as.character(USGS11377100$raw$site_no[[1]]),"_","POR_stats.csv",sep="")))
write.csv(USGS11377100$record_stats$Thresholds$Totals, file=file.path(maindir, gaugedir, recordstatsdir, paste(as.character(USGS11377100$raw$site_no[[1]]),"_","Thresholds_stats.csv",sep="")))
write.csv(as.data.frame(USGS11377100$record_stats$Thresholds$coded), file=file.path(maindir, gaugedir, recordstatsdir, paste(as.character(USGS11377100$raw$site_no[[1]]),"_","Thresholds_coded.csv",sep="")))
...
for(n in 1:length(USGS11377100$Winter_3mon$Data)){
	...
	write.csv(paddf(USGS11377100$Winter_3mon$Stats[[n]]$Values), 
			file=file.path(maindir,gaugedir,threemondir, sub1dir[[1]], names(USGS11377100$Winter_3mon$Data)[[n]],
...
for(n in 2:7){
	...
	write.csv(paddf(USGS11377100$Winter_3mon[[n+1]]$Stats[1:7]), 
...
for(n in 1:length(USGS11377100$Winter_6mon$Data)){
	...
	write.csv(paddf(USGS11377100$Winter_6mon$Stats[[n]]$Values), 
			file=file.path(maindir,gaugedir,sixmondir, sub1dir[[1]], names(USGS11377100$Winter_6mon$Data)[[n]],
...
for(n in 2:7){
	...
	write.csv(paddf(USGS11377100$Winter_6mon[[n+1]]$Stats[1:7]), 
...
for(n in 1:length(USGS11377100$Winter_monthly$Data)){
	...
	for(m in 1:6){
		...
		write.csv(paddf(USGS11377100$Winter_monthly$Stats[[n]][[m]]$Values), 
			file=file.path(maindir,gaugedir,mondir, sub1dir[[1]], names(USGS11377100$Winter_monthly$Data)[[n]],monthlywinter[[m]],
...
for(n in 2:7){
	for(m in 1:6){
		...
		write.csv(paddf(USGS11377100$Winter_monthly[[n+1]][[m]]$Stats[1:7]), 
...
for(n in 1:length(USGS11377100$HydroYear$Data)){
	dir.create(file.path(maindir,gaugedir,hydroyeardir, sub1dir[[1]], names(USGS11377100$HydroYear$Data)[[n]]))
	
	write.csv(USGS11377100$HydroYear$Data[[n]], 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[1]], names(USGS11377100$HydroYear$Data)[[n]],
					paste("HydroYearData_",names(USGS11377100$HydroYear$Data)[[n]],"_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
	write.csv(paddf(USGS11377100$HydroYear$Stats[[n]]$Values), 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[1]], names(USGS11377100$HydroYear$Data)[[n]],
					paste("HydroYearStats_",names(USGS11377100$HydroYear$Data)[[n]],"_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
	write.csv(USGS11377100$HydroYear$Stats[[n]]$Thresholds$Totals, 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[1]], names(USGS11377100$HydroYear$Data)[[n]],
					paste("HydroYearThresholds_",names(USGS11377100$HydroYear$Data)[[n]],"_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
	write.csv(as.data.frame(USGS11377100$HydroYear$Stats[[n]]$Thresholds$coded), 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[1]], names(USGS11377100$HydroYear$Data)[[n]],
					paste("HydroYearThresholdCodes_",names(USGS11377100$HydroYear$Data)[[n]],"_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
}

for(n in 2:7){
	write.csv(USGS11377100$HydroYear[[n+1]]$Data, 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[n]],paste(names(USGS11377100$Winter_monthly)[[n+1]],"_","data_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
	write.csv(paddf(USGS11377100$HydroYear[[n+1]]$Stats[1:7]), 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[n]], paste(names(USGS11377100$Winter_monthly)[[n+1]],"_","stats_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
	write.csv(USGS11377100$HydroYear[[n+1]]$Stats$Thresholds$Totals, 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[n]],paste(names(USGS11377100$Winter_monthly)[[n+1]],"_","threshold_stats_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
	write.csv(as.data.frame(USGS11377100$HydroYear[[n+1]]$Stats$Thresholds$coded), 
			file=file.path(maindir,gaugedir,hydroyeardir, sub1dir[[n]],paste(names(USGS11377100$Winter_monthly)[[n+1]],"_","threshold_coded_",as.character(USGS11377100$raw$site_no[[1]]),".csv",sep="")))
}
